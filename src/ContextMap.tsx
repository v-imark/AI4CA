...
function ContextMap() {
  ...
  const [coordiantes, setCoordinates] = useState({longitude: 15.186464, latitude: 62.862626});
  ...
  <div ref={divRef} style={{ width: "100%", height: "100%" }}>
      ...
      >
        ...
        pitchAlignment="map"
        anchor="center">
          <div style={{width: 50, height: 50, backgroundColor:"rgba(255,255,255,0.1)", border:"1px solid rgba(255,255,255,0.5)"}}></div>
